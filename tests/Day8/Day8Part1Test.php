...
use Ewald\AdventOfCode2025\Day8\Day8Part1;
use Ewald\AdventOfCode2025\Day8\Point;
use PHPUnit\Framework\TestCase;

class Day8Part1Test extends TestCase
{
    public Day8Part1 $instance;
    ...
    public function testGetCircuits(): void
    {
        $points = $this->instance->loadPoints($this->example);
        $pairs = $this->instance->getClosestPairs($points, 10);
        $circuits = $this->instance->getCircuits($pairs, $points);
        $this->assertCount(11, $circuits);
        $this->assertCount(5, $circuits[0]);
    }
    ...
    public function testGetSolution(): void
    {
        ...
        $this->assertEquals(40, $solution);
    }

    public function testSolveWithExample(): void
    {
        $expectedOutput = 40;
        $instance = new Day8Part1();
        $instance->maxPairs = 10;
